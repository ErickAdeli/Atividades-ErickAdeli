...
<body style="overflow-x: hidden;">
    ...
    <h1 style="text-align: center; background-color: lightgray"> Área do Operador</h1>

    <div class="dropdown" >


      <a class="btn btn-secondary" href="{{ route('procedure.index') }}">Listar/Editar/Procedimentos</a>
